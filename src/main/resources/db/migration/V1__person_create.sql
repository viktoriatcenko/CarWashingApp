...
create table person_app (id bigserial not null, created_at timestamp(6), created_by varchar(255), deleted_at timestamp(6), can_give_discount boolean, removed boolean, name varchar(255), password varchar(255), role varchar, primary key (id));
...
insert into offer (cost, discount_max, discount_min, hour_of_start, is_confirmed, is_offer_realized, name, box_id)
values (100, 10, 0, '08:00', TRUE, FALSE, 'offer1', 1);